...
public class SmackCcsClient {
    ...
    private static List<MessageListener> upstreamMessageListeners = new ArrayList<>();
    ...
    public void addMessageListener(MessageListener listener) {
        upstreamMessageListeners.add(listener);
    }
        ...
        connection.addPacketListener(packet -> {
            ...
            try {
                ...
                if (messageType == null) {
                    ...
                    upstreamMessageListeners.forEach(listener -> {
